...
namespace Cosmos
{
    ...
    public:
        ...
        /// @brief constructor
        explicit CoreWidget(ApplicationBase* app);
    ...
    private:
        ...
        static void DrawFXBox(const char* effectName, float boxWidth, float boxHeight, float leftButtonWidth, float titleYOffset, float innerXOffset, float innerYOffset, float smallButtonSize, const std::function<void()>& onLeftButtonClick, const std::function<void()>& onSettingsClick);
