...
namespace Cosmos
{
    ...
    public:
        ...
        /// @brief constructor
        explicit Effect(const char* name, bool enabled = false) : mName(name), mEnabled(enabled) {}
    ...
    public:
        ...
        /// @brief constructor
        explicit Tremolo(const char* name) : Effect(name) {}
    ...
    public:
        ...
        /// @brief called when settings button is clicked
        inline void OnSettings() override
        {
        }

        /// @brief called when left button is clicked
        inline void OnLeftButton() override
        {
            mEnabled = !mEnabled;
        }
    };
    ...
    public:
        ...
        /// @brief constructor
        explicit Overdrive(const char* name) : Effect(name) {}
    ...
    public:
        ...
        /// @brief constructor
        explicit Distortion(const char* name) : Effect(name) {}
    ...
    public:
        ...
        /// @brief constructor
        explicit Delay(const char* name) : Effect(name) {}
    ...
    public:
        ...
        /// @brief constructor
        explicit Reverb(const char* name) : Effect(name) {}
    ...
    public:
        ...
        /// @brief constructor
        explicit Compression(const char* name) : Effect(name) {}
