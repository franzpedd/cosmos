...
namespace Cosmos
{
	...
	public:
		...
		/// @brief writes a data file to a file  (THIS IS CURRENTLY NOT PORTABLE)
	...
	public:
        ...
        /// @brief trying to access a children node
	...
	public:
		...
		/// @brief returns the number of values a property has
		...
		/// @brief returns if either a property of this node exists or not
	...
	public:
		...
		/// @brief sets a new string value of a property
	...
	private:
		...
		/// @brief recursively writes to a data file to a file
		...
		/// @brief returns the indentation level stringified
		...
		/// @brief removes the white spaces of a string
