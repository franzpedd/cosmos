...
namespace Cosmos
{
	...
	void GUI::SetStyle(Style style)
	{
		switch (style)
		{
			case Style::Classic: { ImGui::StyleColorsClassic(); mCurrentStyle = Style::Classic; break; }
			case Style::Darkish: { SetDarkishTheme(); break; }
			case Style::Dark: { SetDarkTheme(); break; }
			case Style::Light: { SetLightTheme(); break; }
			case Style::Sunset: { SetSunsetTheme(); break; }
			case Style::PurpleHaze: { SetPurpleHazeTheme(); break; }
	...
	void GUI::SetDarkTheme()
	{
		...
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.32f, 0.32f, 0.36f, 1.00f);
		...
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.30f, 0.70f, 1.00f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.30f, 0.70f, 1.00f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.30f, 0.30f, 0.34f, 0.25f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.30f, 0.70f, 1.00f, 0.67f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.30f, 0.70f, 1.00f, 0.95f);
		colors[ImGuiCol_Tab] = ImVec4(0.16f, 0.16f, 0.18f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.30f, 0.70f, 1.00f, 0.80f);
		colors[ImGuiCol_TabActive] = ImVec4(0.25f, 0.25f, 0.28f, 1.00f);
		...
		colors[ImGuiCol_DockingPreview] = ImVec4(0.30f, 0.70f, 1.00f, 1.00f);
		...
		colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
		colors[ImGuiCol_NavHighlight] = ImVec4(0.30f, 0.70f, 1.00f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.20f);
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.35f);

		mCurrentStyle = Style::Dark;
	}
	...
	void GUI::SetLightTheme()
	{
		...
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.95f, 0.95f, 0.97f, 1.00f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.90f, 0.90f, 0.92f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.88f, 0.88f, 0.90f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.82f, 0.82f, 0.84f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.88f, 0.88f, 0.90f, 0.51f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.90f, 0.90f, 0.92f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.85f, 0.85f, 0.87f, 0.50f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.75f, 0.75f, 0.77f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.65f, 0.65f, 0.67f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.55f, 0.55f, 0.57f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.16f, 0.52f, 0.88f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.16f, 0.52f, 0.88f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.12f, 0.42f, 0.78f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.85f, 0.85f, 0.87f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.75f, 0.75f, 0.77f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.65f, 0.65f, 0.67f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.80f, 0.80f, 0.82f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.70f, 0.70f, 0.72f, 1.00f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.60f, 0.60f, 0.62f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.80f, 0.80f, 0.82f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.16f, 0.52f, 0.88f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.16f, 0.52f, 0.88f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.16f, 0.52f, 0.88f, 0.25f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.16f, 0.52f, 0.88f, 0.67f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.16f, 0.52f, 0.88f, 0.95f);
		colors[ImGuiCol_Tab] = ImVec4(0.90f, 0.90f, 0.92f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.16f, 0.52f, 0.88f, 0.80f);
		colors[ImGuiCol_TabActive] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.94f, 0.94f, 0.96f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.98f, 0.98f, 1.00f, 1.00f);
		colors[ImGuiCol_DockingPreview] = ImVec4(0.16f, 0.52f, 0.88f, 1.00f);
		colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.88f, 0.88f, 0.90f, 1.00f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.40f, 0.40f, 0.42f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.43f, 0.35f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.00f, 0.60f, 0.00f, 1.00f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.16f, 0.52f, 0.88f, 0.35f);
		colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
		colors[ImGuiCol_NavHighlight] = ImVec4(0.16f, 0.52f, 0.88f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.10f, 0.10f, 0.12f, 0.70f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.20f);
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.35f);

		mCurrentStyle = Style::Light;
	}

	void GUI::SetSunsetTheme()
	{
		ImGuiStyle& style = ImGui::GetStyle();
		...
		colors[ImGuiCol_TextDisabled] = ImVec4(0.70f, 0.60f, 0.50f, 1.00f);
		colors[ImGuiCol_WindowBg] = ImVec4(0.18f, 0.12f, 0.10f, 1.00f);
		colors[ImGuiCol_ChildBg] = ImVec4(0.20f, 0.14f, 0.12f, 1.00f);
		colors[ImGuiCol_PopupBg] = ImVec4(0.22f, 0.16f, 0.14f, 0.98f);
		colors[ImGuiCol_Border] = ImVec4(0.80f, 0.50f, 0.30f, 0.60f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.28f, 0.20f, 0.18f, 1.00f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.35f, 0.25f, 0.22f, 1.00f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.40f, 0.30f, 0.25f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.22f, 0.14f, 0.10f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.28f, 0.18f, 0.14f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.18f, 0.12f, 0.08f, 0.51f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.22f, 0.14f, 0.10f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.20f, 0.14f, 0.10f, 0.50f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.80f, 0.50f, 0.30f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.90f, 0.60f, 0.40f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(1.00f, 0.70f, 0.50f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(1.00f, 0.65f, 0.30f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(1.00f, 0.65f, 0.30f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(1.00f, 0.75f, 0.40f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.80f, 0.50f, 0.30f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.90f, 0.60f, 0.40f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(1.00f, 0.70f, 0.50f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.80f, 0.50f, 0.30f, 0.70f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.90f, 0.60f, 0.40f, 0.80f);
		colors[ImGuiCol_HeaderActive] = ImVec4(1.00f, 0.70f, 0.50f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.80f, 0.50f, 0.30f, 0.60f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(1.00f, 0.65f, 0.30f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(1.00f, 0.70f, 0.40f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(1.00f, 0.65f, 0.30f, 0.25f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(1.00f, 0.65f, 0.30f, 0.67f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(1.00f, 0.70f, 0.40f, 0.95f);
		colors[ImGuiCol_Tab] = ImVec4(0.25f, 0.16f, 0.12f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(1.00f, 0.65f, 0.30f, 0.80f);
		colors[ImGuiCol_TabActive] = ImVec4(0.35f, 0.22f, 0.18f, 1.00f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.20f, 0.14f, 0.10f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.28f, 0.18f, 0.14f, 1.00f);
		colors[ImGuiCol_DockingPreview] = ImVec4(1.00f, 0.65f, 0.30f, 1.00f);
		colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.15f, 0.10f, 0.08f, 1.00f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.80f, 0.60f, 0.40f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.43f, 0.35f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(1.00f, 0.70f, 0.20f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.00f, 0.80f, 0.30f, 1.00f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(1.00f, 0.65f, 0.30f, 0.35f);
		colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 0.80f, 0.20f, 0.90f);
		colors[ImGuiCol_NavHighlight] = ImVec4(1.00f, 0.65f, 0.30f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.20f);
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.35f);

		mCurrentStyle = Style::Sunset;
	}

	void GUI::SetPurpleHazeTheme()
	{
		ImGuiStyle& style = ImGui::GetStyle();
		...
		colors[ImGuiCol_WindowBg] = ImVec4(0.12f, 0.08f, 0.18f, 1.00f);
		colors[ImGuiCol_ChildBg] = ImVec4(0.14f, 0.10f, 0.20f, 1.00f);
		colors[ImGuiCol_PopupBg] = ImVec4(0.16f, 0.12f, 0.22f, 0.98f);
		colors[ImGuiCol_Border] = ImVec4(0.70f, 0.40f, 0.80f, 0.60f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.20f, 0.15f, 0.28f, 1.00f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.28f, 0.20f, 0.38f, 1.00f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.35f, 0.25f, 0.45f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.16f, 0.10f, 0.22f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.22f, 0.14f, 0.30f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.12f, 0.08f, 0.18f, 0.51f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.16f, 0.10f, 0.22f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.14f, 0.10f, 0.20f, 0.50f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.70f, 0.40f, 0.80f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.80f, 0.50f, 0.90f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.90f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.90f, 0.50f, 1.00f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.90f, 0.50f, 1.00f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(1.00f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.70f, 0.40f, 0.80f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.80f, 0.50f, 0.90f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.90f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.70f, 0.40f, 0.80f, 0.70f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.80f, 0.50f, 0.90f, 0.80f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.90f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.70f, 0.40f, 0.80f, 0.60f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.90f, 0.50f, 1.00f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(1.00f, 0.60f, 1.00f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.90f, 0.50f, 1.00f, 0.25f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.90f, 0.50f, 1.00f, 0.67f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(1.00f, 0.60f, 1.00f, 0.95f);
		colors[ImGuiCol_Tab] = ImVec4(0.18f, 0.12f, 0.24f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.90f, 0.50f, 1.00f, 0.80f);
		colors[ImGuiCol_TabActive] = ImVec4(0.28f, 0.18f, 0.38f, 1.00f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.14f, 0.10f, 0.20f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.20f, 0.14f, 0.28f, 1.00f);
		colors[ImGuiCol_DockingPreview] = ImVec4(0.90f, 0.50f, 1.00f, 1.00f);
		colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.10f, 0.06f, 0.14f, 1.00f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.80f, 0.60f, 0.90f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.60f, 0.80f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.50f, 1.00f, 1.00f);
		...
		colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 0.60f, 1.00f, 0.90f);
		colors[ImGuiCol_NavHighlight] = ImVec4(0.90f, 0.50f, 1.00f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.20f);
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.35f);

		mCurrentStyle = Style::PurpleHaze;
	}
