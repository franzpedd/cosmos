## About
Cosmos is a 3D renderer/framework engine for developing applications on multi-platforms. It's currently on early stages of development but already works on Windows, Linux (X11) and Android.
...
## Project: Agenda (Desktop)
This project is just a example of a calendar application, with data serialization/deserialization for persistent data between app closing/opening. I'll attempt to use it myself.
<p align="center">
    <img src="Docs/img/Agenda_Win32.png" alt="Agenda" width="40%">
</p>
...
* [EVK](https://github.com/franzpedd/evk) / [MIT License](https://github.com/franzpedd/evk/blob/main/LICENSE): Vulkan Renderer.    
...
Cosmos is licensed under [MIT License](LICENSE)